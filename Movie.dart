...
class Movie       implements Imh_Object
{
  ...
  @override
  set images(List<NoteImage> list)
  {
    this.Images = [];
  ...
  factory Movie.fromJson(Map<String, Object?> json, [bool isWithFirebaseID = false])
  {
      ...
      Movie movie = Movie(
                      ...
                      Editor:       (json['Editor'] != null) ? json['Editor'] as String : "",
                      Music:        (json['Music'] != null) ? json['Music'] as String : "",
  ...
  factory Movie.fromJsonDatabase(Map<String, dynamic> jsonObject)
  {
    ...
    Movie movie = Movie(
              ...
              Music: jsonObject['Music'] as String,
              ...
              Editor: jsonObject['Editor'] as String,
  ...
  // @override
  void addImage2(NoteImage value)
  {
    this.Images.add(value);
  }

  @override
  void addImage(NoteImage noteImage)
  {
