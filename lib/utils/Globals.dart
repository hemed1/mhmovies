...
class Globals
{
  ...
  static bool             isMainInitApplicationLoaded = false;
  ...
  static Image getImageByListType(Movie movie) //async
  {
    String imageName='listtype_task.png';
    late Image image;
  ...
  static Color translateMainColor() /*async*/
  {
    Color color = Colors.deepPurple;


    switch  (Globals.g_colorsPattern)
    {
      case 0:
        {
          Colors.deepPurple;
      ...
      case 1:
        {
          color = g_mainMediumColor;     //Colors.orangeAccent;
          break;
        }
      case 2:
        {
