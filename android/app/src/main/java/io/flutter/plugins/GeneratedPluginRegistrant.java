...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.kat_html_editor.KatHtmlEditorPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin kat_html_editor, com.example.kat_html_editor.KatHtmlEditorPlugin", e);
    }
    try {
